...
public class Add4ParameterizedTest {
	...
	return Arrays.asList(new Double[][] { { 3.0, 1.0, 2.0, 0.0, 0.0 }, // {0.5,1.0,2.0},
		{ 5.0, 2.0, 3.0, 0.0, 0.0 }, // { 0.66, 2.0, 3.0 },
		{ 7.0, 3.0, 4.0, 0.0, 0.0 }, // { 0.75, 3.0, 4.0 },
		{ 9.0, 4.0, 5.0, 0.0, 0.0 }, // { 0.8, 4.0, 5.0 },
	});
    }
